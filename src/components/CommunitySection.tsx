    ...
    <section className="py-16 sm:py-24 lg:py-28 border-b border-white/[0.08]" id="community">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 sm:mb-16 border-b border-white/[0.08] pb-8">
        <div className="space-y-3">
          <span className="studio-index">03 / COMMUNITY & LEADERSHIP</span>
          ...
          <SpotlightCard key={role.number} className="p-6 sm:p-8 space-y-6 flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-white/[0.08] pb-4">
                <span className="font-mono text-3xl font-bold text-[var(--accent)]">{role.number}</span>
              ...
              <div className="space-y-1">
                ...
                <h4 className="font-mono text-xs sm:text-sm text-[var(--accent)] font-medium">{role.organization}</h4>
              </div>
            ...
            <div className="pt-4 border-t border-white/[0.08] flex items-center justify-between font-mono text-xs text-[var(--text-muted)]">
              <span>Nile University</span>
              <span className="text-[var(--accent)] font-semibold">● Mentorship</span>
            </div>
          </SpotlightCard>
        ))}
      </div>
